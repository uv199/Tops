...
export default function Login() {
  return (
    <div className=" flex py-5 justify-center">
      <Card className="border-2 border-blue-500 rounded-lg p-5" color="transparent" shadow={false}>
        <Typography
          variant="h4"
        ...
        <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
          ...
          <Typography color="gray" className="mt-4 text-center font-normal">
            ...
            <NavLink to={"/register"} className="font-medium text-blue-500 underline ">
              Register
            </NavLink>
          </Typography>
        </form>
