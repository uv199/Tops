...
export default function Header() {
  ...
  return (
    <div className="relative">
      ...
      <div
        div
        className={`fixed inset-y-0 right-0 w-80 bg-slate-100 text-balck transition-transform duration-300 transform ${
      ...
      >
        ...
        <div className="overflow-y-auto max-h-96">a</div>
      </div>
    </div>
  );
}
