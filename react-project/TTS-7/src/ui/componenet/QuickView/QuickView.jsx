  ...
  return (
    ...
    >
      <div className="perfume-imgs">
        ...
        <div className="rowSliderimgs">
          <img
            src="https://www.houseofem5.com/cdn/shop/files/Aqua-ScentProfile_800x.jpg?v=1710331596"
            style={{ height: "200px", width: "150px", padding: "10px" }}
            alt=""
          />
        </div>
      ...
      <div className="em5_txt" style={{ margin: "10px" }}>
        ...
        >
          <p>Size:Perfume Spray (50 ml)</p>
        </div>

        <div className="perfume-btn">
          <div>
            <Button>PERFUME SPRAY (50 ML)</Button>
          </div>
          <div>
            <Button>PERFUME SPRAY (15 ML)</Button>
          </div>
        </div>
